...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/map.txt", __ASSET__assets_data_map_txt);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_map_txt extends flash.utils.ByteArray { }
...
@:file("assets/data/map.txt") #if display private #end class __ASSET__assets_data_map_txt extends lime.utils.Bytes {}
