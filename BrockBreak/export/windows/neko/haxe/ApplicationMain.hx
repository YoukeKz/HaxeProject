...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "TestProj", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "TestProj";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TestProj", null, { width: 640, height: 480 });
